        ...
        <div class="container" ng-app="CSApp" >
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="col-md-2 col-xs-6" data-ng-repeat="i in phones">

                            <a href="${pageContext.request.contextPath}/{{i['pUrl']}}">
                                <img class="img-responsive img-portfolio img-hover" src="{{i['imgLink']}}" alt="" style="height:150px">
                                {{i['productName']}}
                            </a>
                            <a href=""></a>
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="col-md-2 col-xs-6" data-ng-repeat="i in tvs">

                            <a href="${pageContext.request.contextPath}/{{i['pUrl']}}">
                                <img class="img-responsive img-portfolio img-hover" src="{{i['imgLink']}}" alt="" style="max-height:150px">
                                {{i['productName']}}
                            </a>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-2 col-xs-6" data-ng-repeat="i in pbs">
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                            <div class="col-md-2 col-xs-6" data-ng-repeat="i in headphones">
                        <a href="${pageContext.request.contextPath}/{{i['pUrl']}}">
                                <img class="img-responsive img-portfolio img-hover" src="{{i['imgLink']}}" alt="" style="max-height:150px">
                                {{i['productName']}}
                            </a>
          ...
          <div class="row">
            <div class="col-lg-6">
                <ul class="list-inline">
                    <li><a href="${pageContext.request.contextPath}/aboutus11">About Us</a></li>
